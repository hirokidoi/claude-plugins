...
def main() -> None:
    ...
    # Analytics table (90-day retention)
    deleted_tk = state.cleanup_old_tenno_koe_evals(keep_days=90)
    deleted_total = deleted_gt + deleted_up + deleted_gd + deleted_sc + deleted_ak + deleted_ss + deleted_tk
    if deleted_total:
        print(
